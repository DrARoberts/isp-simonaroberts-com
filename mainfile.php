...
if (!defined('API_MAINFILE_INCLUDED')) {
    ...
    define('API_PATH', __DIR__ . DIRECTORY_SEPARATOR . 'api_data');
    ...
    if (isset($_SERVER['HTTP_HOST']))
        ...
        define('API_URL', 'http://isp.simonaroberts.com.localhost:80');
    ...
    if (isset($_SERVER['HTTP_HOST']))
        ...
        define('API_COOKIE_DOMAIN', '.isp.simonaroberts.com.localhost');
