...
<div class="main">
    ...
    <h1>Missing Record for Key Hash -- <?php echo $pagetitle; ?></h1>
    <p>The <?php echo $pagetitle; ?> Website/Server Hosting Services Record Claim was not locatable for the key hash: <?php echo $_REQUEST['key']; ?>.</p>
</div>
</html>
<?php 
