    ...
    <p style="text-align: center; font-size: 185.1831% !important; ">
        <form action="<?php echo API_URL . '/v1/' . $_REQUEST['key'] . "/countries/editing.html";; ?>" method="post">
        	<div style="width: 100%; clear: both;">
            	<div style="width: 100%; clear: both;">
            		<div style="float: left; width: 444px; margin-right: 11px"><label for="modal-<?php echo $modal; ?>">Website/Server Hosting (That is you provide server space on the internet)</label></div>
