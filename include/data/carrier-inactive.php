...
<div class="main">
    ...
    <p>The <?php echo $pagetitle; ?> Telco Phone Carrier Record Claim was finished and filed on <?php echo date('D, D-m-Y H:i:s', $GLOBALS['claim']['finished']); ?>; for the company name <?php echo $GLOBALS['claim']['companyname']; ?>.</p>
</div>
</html>
<?php 
