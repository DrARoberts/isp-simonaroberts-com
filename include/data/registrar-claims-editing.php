...
<div class="main">
    ...
    <p>You need to deselect any other type of business modal that is not applicable; remember this record hostname is only for the Domain Registrar Data only, it wouldn't include hosting business information, Internet Service Provider information or even telco carrier information.</p>
    <p style="text-align: center; font-size: 185.1831% !important; ">
        <form action="<?php echo API_URL . '/v1/' . $_REQUEST['key'] . "/claims/editing.html";; ?>" method="post">
...
?>    		<input type="hidden" id="ssls" name="claims[ssl][<?php echo $hostname; ?>]" value="<?php echo $hostssl; ?>" ></input>
	<?php } 
			...
			echo "\t\t\t<table class='add-claim' id='add-claim' style='vertical-align: top !important; min-width: 100%; margin-top: 16px; margin-bottom: 11px;'>";
            echo "\t\t\t\t<tr>";
