        ...
        <form action="<?php echo API_URL . '/v1/' . $_REQUEST['key'] . "/countries/editing.html";; ?>" method="post">
        	<div style="width: 100%; clear: both;">
            	<div style="width: 100%; clear: both;">
            		...
            		<div style="float: left; width: auto; margin-right: 11px"><label for="modal-<?php echo $modal; ?>">Realm/TLD/gTLD Registrar as a Business&nbsp;<font style="font-size: 64% !important; color: rgb(190, 40, 90);">(That is you provide domain registrarion for the internet)</font></label></div>
            	</div>
    		</div>
